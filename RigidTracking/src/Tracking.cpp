/*
 * File: Tracking.cpp
 * Created Date: Monday, December 30th 2024, 11:11:40 am
 * Author: Zentetsu
 *
 * ----
 *
 * Last Modified: Tue Dec 31 2024
...
bool read_data(unsigned int cpt, const std::string &input_directory, vpImage<vpRGBa> &I_color, vpImage<uint16_t> &I_depth_raw, pcl::PointCloud<pcl::PointXYZ>::Ptr &pointcloud) {
